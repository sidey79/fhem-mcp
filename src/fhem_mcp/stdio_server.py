...
class StdioMcpServer:
    ...
    def _tools(self) -> list[dict[str, Any]]:
        return [
            ...
            {"name": "find_references", "description": "Find likely references with heuristic scoring", "inputSchema": {"type": "object", "properties": {"reference": {"type": "string"}, "relative_path": {"type": "string"}}, "required": ["reference"], "additionalProperties": False}},
